locals {
  ...
  nsa_cisa_v1_cronjob_common_tags = merge(local.nsa_cisa_v1_common_tags, {
    service = "Kubernetes/CronJob"
  })

  extra_checks_cronjob_common_tags = merge(local.extra_checks_tags, {
    service = "Kubernetes/CronJob"
  })
}
...
control "cronjob_cpu_limit" {
  ...
  tags        = local.nsa_cisa_v1_cronjob_common_tags
}
...
control "cronjob_container_readiness_probe" {
  ...
  tags        = local.extra_checks_cronjob_common_tags
}
