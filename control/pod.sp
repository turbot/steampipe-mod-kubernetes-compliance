locals {
  ...
  nsa_cisa_v1_pod_common_tags = merge(local.nsa_cisa_v1_common_tags, {
    service = "Kubernetes/Pod"
  })

  extra_checks_pod_common_tags = merge(local.extra_checks_tags, {
    service = "Kubernetes/Pod"
  })
}
...
control "pod_volume_host_path" {
  ...
  tags        = local.nsa_cisa_v1_pod_common_tags
}
