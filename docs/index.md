...
The benchmark queries use common properties (like `connection_name`, `context_name`, `namespace`, `source_type` and `path`) and tags are defined in the form of a default list of strings in the `mod.sp` file. These properties can be overwritten in several ways:
...
- Pass in a value on the command line:
  ...
  ```shell
  steampipe check benchmark.cis_kube_v120 --var 'common_dimensions=["connection_name", "context_name", "namespace", "source_type", "path"]'
  ```
...
- Set an environment variable:
  ...
  ```shell
  SP_VAR_common_dimensions='["connection_name", "context_name", "namespace", "source_type", "path"]' steampipe check control.cis_kube_v120_v100_5_2_1
  ```
