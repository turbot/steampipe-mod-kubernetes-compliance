benchmark "container_privilege_port_mapped" {
  title       = "Privileged ports [0, 1024] should not mapped with containers"
  description = "The TCP/IP port numbers `O to 1024` are considered privileged ports and should not be mapped with container for security reason."
