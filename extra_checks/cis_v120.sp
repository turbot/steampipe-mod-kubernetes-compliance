...
benchmark "cis_v120" {
  title       = "CIS v1.2.0"
  documentation = file("./extra_checks/docs/cis_v120_overview.md")
...
benchmark "cis_v120_5" {
  title       = "5 Policies (Pod Security Policies)"
  ...
  children = [
    control.cis_v120_5_1_6,
    control.cis_v120_5_2_1,
    control.cis_v120_5_2_2,
    control.cis_v120_5_2_3,
    control.cis_v120_5_2_4,
    control.cis_v120_5_2_5,
    control.cis_v120_5_2_6,
    benchmark.cis_v120_5_3_2,
    control.cis_v120_5_7_2,
