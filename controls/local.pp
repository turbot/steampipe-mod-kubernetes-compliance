locals {
  ...
  pod_service_account_not_exist_desc = "Pods should not refer to a service account which is not available."
  ...
  service_type_forbidden_desc = "Containers should not be exposed through a forbidden service type such as `NodePort` or `LoadBalancer`."
}
