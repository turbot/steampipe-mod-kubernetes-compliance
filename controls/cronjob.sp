...
control "cronjob_container_no_argument_hostname_override_configured" {
  ...
  description = "This check ensures that the container in the CronJob does not have argument hostname override configured."
...
control "cronjob_container_argument_kubelet_read_only_port_0" {
  title       = "CronJob containers argument kubelet read-only port should be set to 0"
...
control "cronjob_container_argument_namespace_lifecycle_enabled" {
  title       = "CronJob containers argument admission control plugin NamespaceLifecycle should be enabled"
  description = "This check ensures that the container in the CronJob has argument admission control plugin NamespaceLifecycle enabled."
...
control "cronjob_container_argument_node_restriction_enabled" {
  title       = "CronJob containers argument admission control plugin NodeRestriction should be enabled"
  description = "This check ensures that the container in the CronJob has argument admission control plugin NodeRestriction enabled."
...
control "cronjob_container_argument_pod_security_policy_enabled" {
  title       = "CronJob containers argument admission control plugin PodSecurityPolicy should be enabled"
  description = "This check ensures that the container in the CronJob has argument admission control plugin PodSecurityPolicy enabled."
...
control "cronjob_container_argument_security_context_deny_enabled" {
  title       = "CronJob containers argument admission control plugin where either PodSecurityPolicy or SecurityContextDeny should be enabled"
...
control "cronjob_container_strong_kubelet_cryptographic_ciphers" {
  ...
  description = "This check ensures that the container in the CronJob has kubelet using strong cryptographic ciphers."
...
control "cronjob_container_argument_service_account_enabled" {
  title       = "CronJob containers argument admission control plugin ServiceAccount should be enabled"
...
control "cronjob_container_host_port_not_specified" {
  ...
  description = "This check ensures that the container ports in the CronJob do not have host port specified."
