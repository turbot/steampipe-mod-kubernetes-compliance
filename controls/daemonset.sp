...
control "daemonset_container_argument_kube_scheduler_bind_address_127_0_0_1" {
  title       = "DaemonSet containers argument kube-scheduler bind address should be set to 127.0.0.1"
  description = "This check ensures that the container in the DaemonSet has argument kube-scheduler bind address set to 127.0.0.1."
  query       = query.daemonset_container_argument_kube_scheduler_bind_address_127_0_0_1
...
control "daemonset_container_argument_etcd_peer_certfile_and_peer_keyfile_configured" {
  title       = "DaemonSet containers should have etcd peer certfile and peer keyfile configured appropriately"
  description = "This check ensures that the container in the DaemonSet has etcd peer certfile and peer keyfile configured appropriately."
  query       = query.daemonset_container_argument_etcd_peer_certfile_and_peer_keyfile_configured

  tags = local.daemonset_common_tags
}

control "daemonset_container_argument_kube_controller_manager_bind_address_127_0_0_1" {
  title       = "DaemonSet containers argument kube-controller-manager bind address should be set to 127.0.0.1"
  description = "This check ensures that the container in the DaemonSet has argument kube-controller-manager bind address set to 127.0.0.1."
  query       = query.daemonset_container_argument_kube_controller_manager_bind_address_127_0_0_1
