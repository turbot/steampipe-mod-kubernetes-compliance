locals {
  cis_kube_v120_v100_common_tags = merge(local.cis_kube_v120_common_tags, {
    cis_version = "v1.0.0"
  })
}

locals {
  cis_kube_v120_v100_5_common_tags = merge(local.cis_kube_v120_v100_common_tags, {
    cis_section_id = "5"
  })
}
...
benchmark "cis_kube_v120_v100" {
  ...
  children = [
    benchmark.cis_kube_v120_v100_5
  ]

  tags = merge(local.cis_kube_v120_v100_common_tags, {
    type = "Benchmark"
  })
}
...
benchmark "cis_kube_v120_v100_5_3_2" {
  ...
  documentation = file("./cis_kube_v120/docs/cis_kube_v120_v100_5_3_2.md")
  children = [
...
benchmark "cis_kube_v120_v100_5_7_2" {
  ...
  documentation = file("./cis_kube_v120/docs/cis_kube_v120_v100_5_7_2.md")
  children = [
...
benchmark "cis_kube_v120_v100_5_7_4" {
  ...
  documentation = file("./cis_kube_v120/docs/cis_kube_v120_v100_5_7_4.md")
  children = [
